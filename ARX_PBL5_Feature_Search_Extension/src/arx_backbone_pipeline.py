...
def write_report(payload: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        "- Bản chính ưu tiên cấu trúc ARX gọn 17 input; feature-search nâng cao được giữ riêng như thử nghiệm mở rộng.",
...
def write_self_critique(payload: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        "## Cách nói khi bảo vệ",
        "",
        "Nhóm chọn ARX chỉ cảm biến trong 17 input làm sản phẩm chính vì mô hình đủ tốt, gọn, dễ giải thích và dễ triển khai điều khiển. Feature-search nâng cao và cảm biến ngoài có thể là hướng mở rộng, nhưng không đưa vào bản chính khi lợi ích không đủ lớn so với độ phức tạp.",
        "",
    ]
